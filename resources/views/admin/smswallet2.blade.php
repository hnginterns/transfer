  ...
  <section class="content container" id="bulksms">
        ...
        <div class="row">
          ...
          <div class="col-md-3 col-sm-10 units" >
            <span class="hidden details" data-acctno="0690000005" data-bankcode="044" data-bankname="Zenith Bank"></span>
            <p>Account Name:<span class="account-name">Jonesky</span></p>
            <p class="sms-units">Sms Unit: 1826.00</p>
            <button type="button" class="btn btn-success btn-block top-sms-account" data-toggle="modal" data-target="#smstop">
                Top up
              </button>
          </div>
          <div class="col-md-3 col-sm-10 units" >
            <span class="hidden details" data-acctno="0690000004" data-bankcode="044" data-bankname="Zenith Bank"></span>
            <p>Account Name:<span class="account-name">Samfield</span></p>
            <p class="sms-units">Sms Unit: 2000.00</p>
            <button type="button" class="btn btn-success btn-block top-sms-account" data-toggle="modal" data-target="#smstop">
                Top up
              </button>
          </div>
          <div class="col-md-3 col-sm-10 units" >
            <span class="hidden details" data-acctno="0921318712" data-bankcode="058" data-bankname="Access Bank"></span>
            <p>Account Name:<span class="account-name">Godfred</span></p>
            <p class="sms-units">Sms Unit: 500.00</p>
            <button type="button" class="btn btn-success btn-block top-sms-account" data-toggle="modal" data-target="#smstop">
                Top up
              </button>
          </div>
          <div class="col-md-3 col-sm-10 units" >
            <span class="hidden details" data-acctno="0690000004" data-bankcode="044" data-bankname="Zenith Bank"></span>
            <p>Account Name:<span class="account-name">BigJeo</span></p>
            <p class="sms-units">Sms Unit: 1000.00</p>
            <button type="button" class="btn btn-success btn-block top-sms-account" data-toggle="modal" data-target="#smstop">
                Top up
              </button>
          </div>
