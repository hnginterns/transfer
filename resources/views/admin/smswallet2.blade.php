@extends('layouts.admin') @section('title', 'SMS Account Page ') @section('subtitle', 'Add sms Account/Top up') @section('added_css')
<style type="text/css">
    .units {
        background: #222d32;
        color: #fff;
            ...
            <div class="col-md-3 col-xs-12 units">
                ...
                <div class="small-box">
                    <div class="inner unit">
                        ...
                        <hr> Account Name: <span class="username">{{ $smswalletdetail['username'] }}</span>
            ...
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title centered">Add New Ebulk SMS Details
                        <hr>
                        <p>Before Adding Account, Get Your API Key From <a href="https://www.ebulksms.com/users/api" target="_blank"
                                " data-toggle="tooltip " title="Login to your account navigate to the developer tap and generate your API key
                                ! ">Ebulksms</a></p>
                                       </h4> </div>
                                        <div class="modal-body ">
                                            <form action="addSmsAccount " method="post " accept-charset="utf-8 ">
                                                ...
                                                <div class="modal-body " style="padding: 5px; ">
                                                    <div class="row ">
                                                        <div class="col-lg-12 col-md-12 col-sm-12 " style="padding-bottom:
                                10px; ">
                                                            <input class="form-control " name="username " placeholder="Your
                                Ebulksms Account Email " type="text " required />
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="row ">
                                                        <div class="col-lg-12 col-md-12 col-sm-12 " style="padding-bottom:
                                10px; ">
                                                            <input class="form-control " name="api_key " placeholder="Your
                                Ebulksms Account API Key " type="text " required />
                                                        </div>
                                                    </div>
