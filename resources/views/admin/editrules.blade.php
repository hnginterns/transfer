        ...
        <div class="single-wallet-holder col-md-6">
            <div class="inner-holder">
                  ...
                  <form action="{{ route('update-rule') }}" method="POST" class="form-horizontal" role="form">
                    ...
                    <br><button type="submit" class="btn btn-info btn-md" name="button"><i class="fa fa-refresh" aria-hidden="true"> Update</i></button>
                    <a href="/admin/view-rules" style="padding:10px;" class="btn  btn-md btn-danger" name="button"><i class="fa fa-times" aria-hidden="true"> Cancel</i></a>
