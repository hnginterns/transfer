...
<head>
<meta charset="utf-8">
<title>PaysFund Create Wallet</title>
...
<div class="col-md-11 main-section">
  <div class="content">
    <div class="sub-head text-center lead" >Create Wallet</div>
			<form class="form-group text-center" method="post">
				<input type="text" name="fname" class="form-control input-defaulted" placeholder="Wallet Name">
				...
				<select name="acctype" class="form-control input-defaulted">
					<option value="role">Account Type</option>
					<option value="current">Current</option>
					<option value="savings">Savings</option>
				</select>
				<input type="text" name="description" class="form-control input-defaulted" placeholder="Description">
				<select name="acctype" class="form-control input-defaulted">
					<option value="role">Cycle</option>
					<option value="i">Cycle I</option>
					<option value="ii">Cycle II</option>
					<option value="iii">Cycle III</option>
				</select>
				<input type="text" name="oid" class="form-control input-defaulted" placeholder="Owner ID">
